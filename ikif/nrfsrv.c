...
#define DEVICE_NAME                         "ZTDK"                            /**< Name of device. Will be included in the advertising data. */
...
#define BATTERY_LEVEL_MEAS_INTERVAL         60000                                    /**< Battery level measurement interval (ms). */
...
static void ble_evt_handler(ble_evt_t const * p_ble_evt, void * p_context)
{
    ...
    ikbleEvtHandler(p_ble_evt,p_context);
...
static void advertising_start(void * p_erase_bonds)
{
    ...
    NRF_LOG_INFO("erase_bonds = %d", erase_bonds);
    if (erase_bonds)
    {
        delete_bonds();
...
/**@brief Function for ikCreateOSTask. */
